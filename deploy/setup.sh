...
sudo mkdir -p /var/www/jerney-devops
sudo chown -R $USER:$USER /var/www/jerney-devops

# Copy project files (assumes you've transferred them to ~/Jerney-devops)
cp -r ~/jerney-devops/* /var/www/jerney-devops/

# --- Install backend dependencies ---
echo "📦 Installing backend dependencies..."
cd /var/www/jerney-devops/backend
npm install --production

# --- Build frontend ---
echo "🔨 Building frontend..."
cd /var/www/jerney-devops/frontend
npm install
npm run build

# --- Configure Nginx ---
echo "🌐 Configuring Nginx..."
sudo cp /var/www/jerney-devops/deploy/jerney-nginx.conf /etc/nginx/sites-available/jerney-devops
sudo ln -sf /etc/nginx/sites-available/jerney-devops /etc/nginx/sites-enabled/jerney-devops
